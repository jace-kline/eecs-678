/* Program to demonstrate shared memory working with two processes.
   Parent writes 100 random numbers to shared memory locations.
   Child reads the numbers and prints them out
*/
